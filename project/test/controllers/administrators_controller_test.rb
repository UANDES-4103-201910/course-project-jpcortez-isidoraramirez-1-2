...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { geoference: @administrator.geoference, mail: @administrator.mail, name: @administrator.name, password: @administrator.password, super_admin_id: @administrator.super_admin_id } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { geoference: @administrator.geoference, mail: @administrator.mail, name: @administrator.name, password: @administrator.password, super_admin_id: @administrator.super_admin_id } }
