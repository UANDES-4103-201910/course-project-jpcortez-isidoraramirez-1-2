...
class DumpstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dumpster" do
    assert_difference('Dumpster.count') do
      post dumpsters_url, params: { dumpster: { administrator_id: @dumpster.administrator_id, super_admin_id: @dumpster.super_admin_id } }
    end
  ...
  test "should update dumpster" do
    patch dumpster_url(@dumpster), params: { dumpster: { administrator_id: @dumpster.administrator_id, super_admin_id: @dumpster.super_admin_id } }
