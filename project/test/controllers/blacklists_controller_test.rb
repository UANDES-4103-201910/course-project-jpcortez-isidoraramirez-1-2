...
class BlacklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blacklist" do
    assert_difference('Blacklist.count') do
      post blacklists_url, params: { blacklist: { administrator_id: @blacklist.administrator_id, date: @blacklist.date, super_admin_id: @blacklist.super_admin_id } }
    end
  ...
  test "should update blacklist" do
    patch blacklist_url(@blacklist), params: { blacklist: { administrator_id: @blacklist.administrator_id, date: @blacklist.date, super_admin_id: @blacklist.super_admin_id } }
