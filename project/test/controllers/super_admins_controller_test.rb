...
class SuperAdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create super_admin" do
    assert_difference('SuperAdmin.count') do
      post super_admins_url, params: { super_admin: { mail: @super_admin.mail, name: @super_admin.name, password: @super_admin.password } }
    end
  ...
  test "should update super_admin" do
    patch super_admin_url(@super_admin), params: { super_admin: { mail: @super_admin.mail, name: @super_admin.name, password: @super_admin.password } }
